...
DB_NAME = _app_config.get("DB_NAME", os.getenv("DB_NAME", "stocks_db"))
DB_USER = _app_config.get("DB_USER", os.getenv("DB_USER", "stock_user"))
DB_PASSWORD = _app_config.get("DB_PASSWORD", os.getenv("DB_PASSWORD", "stock_pass"))
